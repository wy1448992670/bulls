        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="widget-container fluid-height clearfix">
                    <div class="heading">
                        <i class="icon-table"></i>添加通道
                    </div>
                    <div class="widget-content padded clearfix">
                        <form action="${basePath}tunnel/add" method="post" class="form-horizontal" id="validate-form">
                            <div class="form-group">
                                <label class="control-label col-md-2">通道名称</label>

                                <div class="col-md-7">
                                    <input class="form-control" name="name" id="name" placeholder="请输入通道名称" type="text">
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-7">
                                    <input class="form-control" name="weight" id="weight" placeholder="请输入通道权重0-100之间"
                                           type="text">
