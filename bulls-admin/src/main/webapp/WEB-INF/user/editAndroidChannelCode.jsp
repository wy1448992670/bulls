        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="widget-container fluid-height clearfix">
                    <div class="heading">
                        <i class="icon-table"></i>新增渠道代码记录
                    </div>
                    <div class="widget-content padded clearfix">
                        <%-- <form action="reply?id=${id}" method="post" --%>
                        <form action="${basePath}user/editAndroidChannel?id=${map.id}&create_id=${map.creater}&create_time=${map.createTime}"
                              method="post"
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-7">
                                    <select class="select2able" name="source" onchange="" >
                                        <option value="0"  <c:if test="${map.source == 0 }">selected</c:if>>安卓</option>
                                        <option value="1" <c:if test="${map.source == 1 }">selected</c:if>>微信</option>
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-7">
                                    <input class="form-control" name="code" id="code" value="${map.code }"
                                           placeholder="请输入渠道代码">
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-md-7">
                                    <input id="company1" name="company" type="hidden" value="${map.roleId }"
                                           placeholder="请选择机构名称"/>
                                    <%-- <input class="form-control" name="company" id="company" value="${map.company }" placeholder="请选择机构名称"> --%>
                                </div>
                            </div>
                            <div class="form-group">
    ...
    $(function () {
        ...
        var option = {
            ...
            initSelection: function (element, callback) {
                callback({id: '${map.roleId}', role: '${map.role}', description: '${map.roleName}'});//调用formatSelection
            },
