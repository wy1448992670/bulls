        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="widget-container fluid-height clearfix">
                    <div class="heading">
                        <i class="icon-table"></i>编辑用户解绑卡信息
                    </div>
                    <div class="widget-content padded clearfix">
                        <form action="${basePath}user/editBankCard" method="post" class="form-horizontal" id="validate-form">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-7">
                                    <input class="form-control" name="cardNo" id="cardNo" disabled="true" type="text" value="${map.cardNo }">
                                </div>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-7">
                                    <select id="payType" name="payType" class="select2" disabled="true">
                                        <option value="0" <c:if test="${map.type == 0}">selected</c:if>>绑定银行卡</option>
                                        <option value="1" <c:if test="${map.type == 1}">selected</c:if>>解绑银行卡</option>
                                    </select>
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-md-7">
                                    <select id="status" name="status" class="select2" onchange="isDisable();" <c:if test="${map.type == 0}">disabled="true"</c:if>>
                                ...
                                <div class="col-md-7">
                                    <c:forEach var="ii" items="${uploads }">
                                        <div style="display: inline-block;margin-right: 10px;">
                                            <a href="${ii.path}" target="_blank">
                                                <img alt="" src="${ii.path}" width="120"/>
                                            </a>
                                        </div>
                                    </c:forEach>
                                </div>
...
//					 }
    ...
    function aa() {
        ...
        if (status == 1) {
            jQuery.ajax({
                url: '${basePath}user/checkIsHasCard',
                type: "GET",
                data: "id=" + id,
                dataType: "json",
