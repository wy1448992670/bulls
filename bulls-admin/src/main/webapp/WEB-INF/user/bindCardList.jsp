        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="widget-container fluid-height clearfix">
                    <div class="heading">
                        <i class="icon-table"></i>用户卡操作列表
                    </div>
                    <div class="widget-content padded clearfix">
                        <form class="form-inline hidden-xs col-lg-3 pull-right" id="form" action="bindCardList">
                            <div class="row">
                            ...
                            <div class="row">
                                <div class="form-group col-md-6">
                                    <select class="select2able" name="type">
                                        ...
                                        <option value="1" <c:if test="${type == 1 }">selected</c:if>>解绑银行卡</option>
                                        <option value="0" <c:if test="${type == 0 }">selected</c:if>>绑定银行卡</option>
                                    </select>
                                </div>
                                <div class="form-group col-md-6">
                                ...
                                <tr>
                                    ...
                                    <td>
                                    	<shiro:lacksPermission name="user:adminPhone">
                                            ${i.cardNo.replaceAll("(\\d{6})\\d{5}(\\w{4})","$1*****$2")}
                                    ...
                                    <td>
                                        <a class="label label-success"><c:if test="${i.type == 0}">绑定银行卡</c:if></a>
                                        <a class="label label-warning"><c:if test="${i.type == 1}">解绑银行卡</c:if></a>
                                    </td>
                                    ...
                                    <td>
                                        <a class="btn btn-primary" href="editBankCard?id=${i.id}&status=${status}&type=${type}&page=${page}">编辑</a>
                                    </td>
                                </tr>
                            </c:forEach>
                            </tbody>
    ...
    $(function () {
        ...
        $('#pagination').bootstrapPaginator({
            ...
            pageUrl: function (type, page, current) {
                return "bindCardList?keyword=${keyword}&status=${status}&type=${type}&page=" + page;
            }
        });
    });
</script>
