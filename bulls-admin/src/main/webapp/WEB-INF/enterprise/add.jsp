                    ...
                    <div class="widget-content padded clearfix">
                        <form action="add" method="post" class="form-horizontal" id="validate-form">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-7">
                                    <input class="form-control" name="no" id="no" placeholder="请输入企业编号 (个人借款则填写身份证号码)" type="text">
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-7">
                                    <input class="form-control" name="name" id="name" placeholder="请输入企业名称 (个人借款则填写借款人姓名)" type="text">
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-7">
                                    <input class="form-control" name="phone" id="phone" placeholder="请输入手机号码" type="text">
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-7">
                                    <input class="form-control" name="cardNumber" id="cardNumber" placeholder="请输入银行卡号" type="text">
                                </div>
                            </div>
...
<script type="text/javascript">
    ...
    function isUserable() {
        ...
        if (flag == 0) {
            $('#range').show();
            $('textarea[name="scope"]').attr("disabled", false);

            $('#condition').show();
            $('textarea[name="conditionState"]').attr("disabled", false);

        } else {
            $('#range').hide();
            $('textarea[name="scope"]').attr("disabled", true);

            $('#condition').hide();
            $('textarea[name="conditionState"]').attr("disabled", true);
