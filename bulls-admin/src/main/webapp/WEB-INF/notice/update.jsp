        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="widget-container fluid-height clearfix">
                    <div class="heading">
                        <i class="icon-table"></i>编辑公告
                    </div>
                    <div class="widget-content padded clearfix">
                        <form action="${basePath}notice/update" method="post" class="form-horizontal"
                              id="validate-form">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-7">
                                    <select class="select2able" name="isShow" id="isShow">
                                        <option value="0" <c:if test="${notice.isShow == 0}">selected</c:if>>否</option>
                                        <option value="1" <c:if test="${notice.isShow == 1}">selected</c:if>>是</option>
                                    </select>
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-md-7">
                                    ...
                                    <textarea rows="" cols="" hidden="true" name="htmlContent"
                                              id="htmlContent">${notice.htmlContent }</textarea>
                                    <textarea rows="" cols="" hidden="true" name="textContent"
                                              id="textContent">${notice.textContent }</textarea>
                                </div>
                            </div>
