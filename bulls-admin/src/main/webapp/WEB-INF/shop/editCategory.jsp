                        ...
                        <form  method="post" class="form-horizontal" id="validate-form" >
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-7 upload-picture"> 
                                    <input class="form-control" value="${category.categoryName }" name="categoryName" id="categoryName" placeholder="分类名称" type="text" />
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-1 upload-picture" id="imgHtml">
                             		<img width="150px" height="150px" src="${category.adUploadPath }"  /> 
                             	 </div>
                             	 <div class="col-md-7" data-toggle="modal" href="#myModal"  id="enterprise-picture">
                           	 		<input type="hidden" name="videoPageUrl" id="picpath" value="${category.adUploadPath }"/>
		...
		.fileupload(
				{
					...
					added : function(e, data) {
						...
						if (data.status == "error") {
							...
							$("#validate-form")
									.append(
											'<input id="picture-' + data.object.id + '" type="hidden" name="adUploadId" value="' + data.id + '"/>');
						}
					}
				});
    });
