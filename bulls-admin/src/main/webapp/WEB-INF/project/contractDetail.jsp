        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="widget-container fluid-height clearfix">
                    <div class="heading">
                        <i class="icon-table"></i>详情或合同内容编辑
                    </div>
                    <div class="widget-content padded clearfix">
                        <form action="${basePath}project/editContractDetail" method="post" class="form-horizontal"
                              id="validate-form">
                            <div class="form-group">
                                <label class="control-label col-md-2">标题</label>

                                <div class="col-md-7">
                                    <input class="form-control" name="title" id="title" placeholder="请输入链接地址"
                                           type="text" value="${map.title }">
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-md-7">
                                    <select id="type" name="type" class="select2">
                                        <option value="0" <c:if test="${map.type == 0}">selected</c:if>>债权</option>
                                        <option value="1" <c:if test="${map.type == 1}">selected</c:if>>散标</option>
                                    </select>
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-md-7">
                                    <input class="form-control" name="url" id="url" placeholder="请输入链接地址" type="text"
                                           value="${map.url }">
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-md-7">
                                    ...
                                    <textarea rows="" cols="" hidden="true" name="htmlContent"
                                              id="htmlContent">${map.htmlContent }</textarea>
                                    <textarea rows="" cols="" hidden="true" name="textContent"
                                              id="textContent">${map.textContent }</textarea>
                                </div>
                            </div>
