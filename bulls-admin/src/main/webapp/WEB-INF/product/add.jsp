                    ...
                    <div class="widget-content padded clearfix">
                        <form action="add" method="post" class="form-horizontal" id="validate-form">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-7">
                                    <input class="form-control" name="name" id="name" placeholder="请输入产品名称"
                                           type="text">
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-7">
                                    <input class="form-control" name="annualizedMin" placeholder="请输入最小利率(1~12数字)" type="text" >
                                </div>
                            </div>
                            <%--<div class="form-group">--%>
                                ...
                                <%--<div class="col-md-7">--%>
                                    <%--<input class="form-control" name="annualizedMax" placeholder="请输入最大利率(1~12数字)"  type="text" >--%>
                                <%--</div>--%>
                            <%--</div>--%>
                            ...
                            <%--<div class="form-group">--%>
                                ...
                                <%--<div class="col-md-7">--%>
                                    <%--<input class="form-control" name="limitDays" placeholder="请输入投资期限,单位为天" type="text">--%>
                                <%--</div>--%>
                            <%--</div>--%>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-7">
                                    <input class="form-control" name="minAmount" id="minAmount"  placeholder="请输入最小起投金额(元)" type="text">
                                </div>
                            </div>
                            <%--<div class="form-group">--%>
                                <%--<label class="control-label col-md-2">最大投资限额</label>--%>
                                <%--<div class="col-md-7">--%>
                                    <%--<input class="form-control" name="maxAmount" id="maxAmount"  placeholder="请输入最大投资限额(元)" type="text">--%>
                                <%--</div>--%>
                            <%--</div>--%>
                            <div class="form-group">
                                <label class="control-label col-md-2">投资递增金额</label>
                                <div class="col-md-7">
                                    <input class="form-control" name="increaseAmount" id="increaseAmount"  placeholder="请输入投资递增金额(元)" type="text">
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="control-label col-md-2">是否支持红包</label>
                                <div class="col-md-7">
                                    <select class="select2able" name="supportHongbao" >
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-7">
                                    <select class="select2able" name="supportCoupon" >
                                        <option value="1">不支持</option>
                                        <option value="0">支持</option>
                                    </select>
                                </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-7">
                                    <input class="form-control" name="outDays" placeholder="请输入退出期限,单位为天" type="text">
                                </div>
                            </div>
