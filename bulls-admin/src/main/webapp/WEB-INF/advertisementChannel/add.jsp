        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="widget-container fluid-height clearfix">
                    <div class="heading">
                        <i class="icon-table"></i>添加推广渠道
                    </div>
                    <div class="widget-content padded clearfix">
                        <form action="${basePath}advertisementChannel/save" method="post" class="form-horizontal" id="validate-form"
                              ENCTYPE="multipart/form-data" onsubmit="return CheckPost();">
                            <div class="form-group">
                                <label class="control-label col-md-2">渠道号</label>

                                <div class="col-md-7">
                                    <input class="form-control" name="channelNo" id="channelNo" placeholder="请输入渠道号" type="text" />
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-md-7">
                                    <input class="form-control" name="channelName" id="channelName" placeholder="请输入渠道名称" type="text" />
                                </div>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-7">
                                    <input class="form-control" name="tongjiKey" id="tongjiKey" placeholder="请输入统计Key" type="text">
                                </div>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-7">
                                    <input class="form-control" name="buttonText" id="buttonText" placeholder="不超过8个字" type="text">
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-md-7">
                                    <input class="form-control" name="successText" id="successText" placeholder="请输入注册成功文本" type="text">
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-md-7">
                                    <input class="form-control" name="redirectUrl" id="redirectUrl" placeholder="请输入跳转url" type="text">
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-md-7">
                                    ...
                                    <%--<textarea class="form-control"  name="guizeText" id="guizeText"  placeholder="请输入文字限制120字" ></textarea>--%>
                                    <!-- 加载编辑器的容器 -->
                                    <script id="container" name="content" type="text/plain" height="500"></script>
                                    <textarea rows="" cols="" hidden="true" name="guizeText" id="guizeText"></textarea>
                                </div>
                            </div>
                            <div class="form-group">
...
<script type="text/javascript">
    $(function () {
        ...
        ue.addListener("keyup", function () {
            ...
            // $('#guizeContent').text(ue.getContentTxt());
        });
