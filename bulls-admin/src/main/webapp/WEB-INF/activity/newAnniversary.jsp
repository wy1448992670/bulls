...
<head>
    ...
    <title>2周年壕礼迎新！新手即送5000元体验金+独享2%加息！</title>
                                ...
                                <div class="form-group col-md-3">
                                    <shiro:hasPermission name="user:export:app">
                                        <a style="margin-left: 10px;"
                                           ...
                                           href="${basePath}report/newAnniversaryReport?activityId=${activityId}&keyword=${keyword}&startTime=<fmt:formatDate value="${startTime }" pattern="yyyy-MM-dd"/>&endTime=<fmt:formatDate value="${endTime }" pattern="yyyy-MM-dd"/>"
    ...
    $(function () {
        ...
        $('#pagination').bootstrapPaginator({
            ...
            pageUrl: function (type, page, current) {
                return "newAnniversary?activityId=${activityId}&keyword=${keyword}&startTime=<fmt:formatDate value="${startTime }" pattern="yyyy-MM-dd"/>&endTime=<fmt:formatDate value="${endTime }" pattern="yyyy-MM-dd"/>&page=" + page;
            }
        });
