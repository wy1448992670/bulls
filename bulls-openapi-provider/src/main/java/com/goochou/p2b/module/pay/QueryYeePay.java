...
import com.goochou.p2b.invocation.impl.QueryYeePayInvocation;


@Service
public class QueryYeePay extends BaseAO implements HessianInterface
{
	
	@Autowired
	private QueryYeePayInvocation queryYeePayInvocation;
    ...
    public Response execute(ServiceMessage msg)
    {
		...
		try {
			response = queryYeePayInvocation.executeService(req);
		} catch (Exception e) {
