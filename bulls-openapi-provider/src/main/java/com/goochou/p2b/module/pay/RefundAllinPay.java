...
import com.goochou.p2b.invocation.impl.RefundAllinPayInvocation;


@Service
public class RefundAllinPay extends BaseAO implements HessianInterface
{
	
	@Autowired
	private RefundAllinPayInvocation refundAllinPayInvocation;
    ...
    public Response execute(ServiceMessage msg)
    {
		...
		try {
			response = refundAllinPayInvocation.executeService(req);
		} catch (Exception e) {
