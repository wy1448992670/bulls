...
import com.goochou.p2b.invocation.impl.AllinPayInvocation;


@Service
public class AllinPay extends BaseAO implements HessianInterface
{
	
	@Autowired
	private AllinPayInvocation allinPayInvocation;
    ...
    public Response execute(ServiceMessage msg)
    {
		...
		try {
			response = allinPayInvocation.executeService(req);
		} catch (Exception e) {
