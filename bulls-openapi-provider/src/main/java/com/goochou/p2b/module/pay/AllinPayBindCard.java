...
import com.goochou.p2b.invocation.impl.AllinPayBindCardInvocation;


@Service
public class AllinPayBindCard extends BaseAO implements HessianInterface
{
	
	@Autowired
	private AllinPayBindCardInvocation allinPayBindCardInvocation;
    ...
    public AllinPayBindCardResponse execute(ServiceMessage msg)
    {
		...
		try {
			response = allinPayBindCardInvocation.executeService(req);
		} catch (Exception e) {
