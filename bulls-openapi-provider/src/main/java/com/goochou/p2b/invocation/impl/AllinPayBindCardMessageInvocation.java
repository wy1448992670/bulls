 ...
 */
@Service
public class AllinPayBindCardMessageInvocation extends BaseInvocation implements IInvocation {
	...
	public AllinPayBindCardResponse executeService(Request request) {
        ...
        String rspJson = "";
        try {
            rspJson = getRspXML(request, PayConstants.METHOD_BIND_CARD_MESSAGE, OutPayEnum.ALLINPAY.getFeatureName());
