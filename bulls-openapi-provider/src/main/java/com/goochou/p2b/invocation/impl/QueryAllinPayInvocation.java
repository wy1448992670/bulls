 ...
 */
@Service
public class QueryAllinPayInvocation extends BaseInvocation implements IInvocation {
	...
	public AllinPayResponse executeService(Request request) {
        ...
        String rspJson = "";
        try {
            rspJson = getRspXML(request, PayConstants.METHOD_QUICK_QUERY_ORDER, OutPayEnum.ALLINPAY.getFeatureName());
	...
	private void setResult(AllinPayResponse res, String rspJson) {
        ...
        if(PayConstants.SUCCESS.equals(code)){
            ...
            if(PayConstants.RESP_CODE_SUCCESS.equals(trxStatus)) {
                res.setSuccess(true);
                //{"acct":"6214850210049661","appid":"00000051","cusid":"990581007426001","fintime":"20190625172148","orderid":"N2019345244455621","randomstr":"781185855814","retcode":"SUCCESS","sign":"41FEB8486408BEF02F0FB3EFAE15C8C9","trxamt":"10000","trxcode":"VSP301","trxid":"111921100001595779","trxstatus":"0000"}
