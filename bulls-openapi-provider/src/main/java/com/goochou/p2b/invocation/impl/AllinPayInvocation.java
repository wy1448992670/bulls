 ...
 */
@Service
public class AllinPayInvocation extends BaseInvocation implements IInvocation {
	...
	public AllinPayResponse executeService(Request request) {
        ...
        String rspJson = "";
        try {
            rspJson = getRspXML(request, PayConstants.METHOD_PAY, OutPayEnum.ALLINPAY.getFeatureName());
	...
	private void setResult(AllinPayResponse res, String rspJson) {
        ...
        if(PayConstants.SUCCESS.equals(code)){
            ...
            if(PayConstants.RESP_CODE_SUCCESS.equals(trxstatus) || "2000".equals(trxstatus)) {
                res.setSuccess(true);
                //{"appid":"00000051","cusid":"990581007426001","fintime":"20190625171608","orderid":"N2019345244455622","randomstr":"780838166328","retcode":"SUCCESS","sign":"CE72840F6DC20ECE98DBE1E42475CE45","trxid":"111921100001595776","trxstatus":"0000"}
