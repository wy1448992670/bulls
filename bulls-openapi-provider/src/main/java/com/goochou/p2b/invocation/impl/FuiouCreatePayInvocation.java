 ...
 * @version        1.0
 */
@Service("fuiouCreatePayInvocation")
public class FuiouCreatePayInvocation extends BaseInvocation implements IInvocation {
	...
	public FuiouDataResponse executeService(Request request) {
        ...
        String rspJson = "";
        try {
            rspJson = getRspXML(request, PayConstants.METHOD_CREATE_PAY, OutPayEnum.FUIOU.getFeatureName());
    ...
    protected String toJSONString(Request request) {
		FuiouCreatePayRequest fsmr = (FuiouCreatePayRequest) request;
