 ...
 */
@Service
public class AllinPayCreatePayInvocation extends BaseInvocation implements IInvocation {
	...
	public AllinPayResponse executeService(Request request) {
        ...
        String rspJson = "";
        try {
            rspJson = getRspXML(request, PayConstants.METHOD_CREATE_PAY, OutPayEnum.ALLINPAY.getFeatureName());
