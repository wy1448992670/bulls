...
import com.goochou.p2b.utils.weixin.WXPayConstants.SignType;
...
public class WXPayUtil {
    ...
    public static String retrieveSandboxSignKey(WXPayConfig config, WXPay wxPay) {
        try {
            ...
            String strXML = HttpPostUtil.postForwardWx("https://api.mch.weixin.qq.com/sandboxnew/pay/getsignkey", params);
...
//            String sandboxSignkey = WXPayUtil.retrieveSandboxSignKey(config, wxpay);
//            if (StringUtils.isBlank(sandboxSignkey)) {
//                throw new Exception("请求沙箱sandbox_signkey失败");
//            }
            Map<String, String> data = new HashMap<String, String>();
            data.put("body", "1111111111111111");
            data.put("out_trade_no", "NO223322132134412");
            data.put("device_info", "");
            data.put("fee_type", "CNY");
            data.put("total_fee", "201");
            data.put("spbill_create_ip", CommonUtil.getLocalIP());
            ...
            try {
                ...
                if(resp.get("return_code").equals("SUCCESS") && resp.get("result_code").equals("SUCCESS")) {
                    System.out.println(resp.get("mweb_url"));
                }
            } catch (Exception e) {
                e.printStackTrace();
            }
