...
public class CacheOperation{ 
     ...
     * 工单弹框缓存关键字
     */
    public static final String CACHE_BMP_KEY = "CACHE_BMP_KEY";
    
    /**
     * 跟进到期提醒数量缓存关键字
     */
    public static final String CACHE_FOLLOW_KEY = "CACHE_FOLLOW_KEY";
    
    /**
     * 跟进到期提醒timer定时器缓存关键字
     */
    public static final String CACHE_TIMER_KEY = "CACHE_TIMER_KEY";
    ...
    */ 
     ...
     */ 
     public void removeAllCacheData(){ 
         cacheMap.clear();
         cacheMap.put(CACHE_FOLLOW_KEY, new CacheData(new HashMap<Object, List<Long>>())); 
         cacheMap.put(CACHE_TIMER_KEY, new CacheData(new HashMap<Object, Timer>())); 
     } 
