...
public abstract class UmengNotification {
	...
	protected static final HashSet<String> ROOT_KEYS = new HashSet<String>(Arrays.asList(new String[]{
			...
			"filter", "production_mode", "feedback", "description", "thirdparty_id", "key", "params"}));
	...
	protected static final HashSet<String> MIPUSH_KEYS = new HashSet<String>(Arrays.asList(new String[]{
			"mipush" 
	}));
