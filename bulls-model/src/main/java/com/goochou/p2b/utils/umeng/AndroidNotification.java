...
public abstract class AndroidNotification extends UmengNotification {
	...
	public boolean setPredefinedKeyValue(String key, Object value) throws Exception {
		...
		} else if(MIPUSH_KEYS.contains(key)){
			rootJson.put("mipush", value);
			rootJson.put("mi_activity", "com.yiyi.rancher.push.MipushTestActivity");
		}else {
	...
	public void setMipush(Boolean isMipush) throws Exception {
		setPredefinedKeyValue("mipush", isMipush);
	}
