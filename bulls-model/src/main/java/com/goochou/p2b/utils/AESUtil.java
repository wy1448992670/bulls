...
public class AESUtil {
    ...
    private static final String default_key="hRDuznX~a7WetdtTv_!krSzYzij6h;V2";


    public static String encrypt(String content) throws Exception {
        return URLEncoder.encode(encrypt(content,default_key),"utf-8");
    }

    public static String decryptWithUrlEncode(String content) throws Exception {
        return decrypt(URLDecoder.decode(content,"utf-8"),default_key);
    }
