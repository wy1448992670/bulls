...
public class NativePlace {
    ...
    public static String getNativePlace(String idCardNum) {

        if(StringUtils.isBlank(idCardNum) ||  idCardNum.length()<6) {
            return "";
        }

        int nativePlaceCode=Integer.parseInt(idCardNum.substring(0, 6));
